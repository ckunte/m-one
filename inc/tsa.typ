= #smallcaps[tsa] for pile welds?

During a project schedule review a year ago, citing past experience, I was asked this following:

#quote()[
  Would the design for pile fatigue warrant applying #smallcaps[tsa] to pile welds? Any delay in realising this requirement, especially late in fabrication has the potential to adversely affect project schedule.
]
...
#quote()[We originally specified #smallcaps[tsa] coating for the piles so that non-seawater S-N curves could be used for the fatigue analysis of the pile girth welds, etc. (Welds are exposed to seawater with no #smallcaps[cp] during driving.) In the end this requirement was waived and no #smallcaps[tsa] coating was applied.]

This was so telling that it blew my mind. It suggested that here was a team years ago trying to hack together a solution for a problem they presumably faced, but perhaps without sufficiently understanding corrosion or fatigue (as a phenomenon) or #smallcaps[tsa] (as a potential solution). 
